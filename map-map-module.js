...
module.exports = "#map_canvas {\n  height: 100%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _map_presenter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./map.presenter */ "./src/app/components/map/map.presenter.ts");
...
var MapPage = /** @class */ (function () {
    function MapPage(platform, state) {
        this.platform = platform;
        this.presenter = new _map_presenter__WEBPACK_IMPORTED_MODULE_4__["MapPresenter"](state);
    }
    ...
    MapPage.prototype.loadMarkers = function () {
        var _this = this;
        this.presenter.venues$.subscribe(function (venues) {
            if (_this.map) {
                var bounds_1 = [];
                _this.map.clear();
                venues.forEach(function (venue) {
                    if (_this.map) {
                        var marker = _this.map.addMarkerSync({
                            title: venue.name,
                            icon: _this.getIcon(venue.category),
                            animation: 'DROP',
                            position: {
                                lat: venue.latitude,
                                lng: venue.longitude
                        ...
                        bounds_1.push(marker.getPosition());
                    }
                });
    ...
    MapPage.prototype.getIcon = function (category) {
        switch (category) {
            case src_app_domain__WEBPACK_IMPORTED_MODULE_3__["VenueCategory"].Business:
                return 'blue';
            case src_app_domain__WEBPACK_IMPORTED_MODULE_3__["VenueCategory"].Official:
                return 'red';
            default:
                return 'green';
        }
    ...
    MapPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_5__["Platform"],
            src_app_domain__WEBPACK_IMPORTED_MODULE_3__["IState"]])
    ], MapPage);
    return MapPage;
}());
...
/***/ "./src/app/components/map/map.presenter.ts":
/*!*************************************************!*\
  !*** ./src/app/components/map/map.presenter.ts ***!
  \*************************************************/
/*! exports provided: MapPresenter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MapPresenter", function() { return MapPresenter; });
var MapPresenter = /** @class */ (function () {
    function MapPresenter(state) {
        this.state = state;
